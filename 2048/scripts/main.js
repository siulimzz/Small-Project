...
// 不同的数字对于不同的颜色,
// colors是颜色的数组
var colors = ["#F4F7F7", "#e3fdfd", "#aacfdd", "#cbf1f5", "#a6e3e9", "#71c9ce", "#79a8a9",
		"#1f4e5f", "#F4F7F7", "#e3fdfd", "#aacfdd", "#cbf1f5"];
...
function init() {
    ...
    window.onkeydown = function (e) {
        ...
        if (!e)
            e = window.event;
        if (document.all) {
            keyCode = e.keyCode;//IE浏览器
        } else {
            keyCode = e.which;//FireFox、Opera、Chrome
        }
        // ← 或 A
